...
class SimpleCache implements CacheInterface
{
    ...
    /*
        The following methods extend Psr\SimpleCache or are internal/private
    */
     ...
     * @param integer                   $failDelay How long to before should retry getter after failure
     *
     ...
     */
    public function getSet($key, callable $getter, $ttl = null, $failDelay = 60)
    {
        $this->assertValidKey($key);
        $expiry = $this->ttlToExpiry($ttl);
        return $this->kvs->getSet($key, $getter, $expiry, $failDelay);
    }
